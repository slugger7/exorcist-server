...
type IVideoService interface {
	...
	GetOverview(limit, skip int) (*models.Page[models.VideoOverviewDTO], error)
...
func (vs *VideoService) GetOverview(limit, skip int) (*models.Page[models.VideoOverviewDTO], error) {
	vidsPage, err := vs.repo.Video().GetOverview(limit, skip)
	if err != nil {

...
func (m *MockIVideoService) GetById(id uuid.UUID) (*models.VideoOverviewDTO, error) {
	m.ctrl.T.Helper()
...
func (m *MockIVideoService) GetOverview(search models.VideoSearchDTO) (*models.Page[models.VideoOverviewDTO], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOverview", search)
...
func (mr *MockIVideoServiceMockRecorder) GetOverview(search any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOverview", reflect.TypeOf((*MockIVideoService)(nil).GetOverview), search)
}

...
func Test_Create_IncorrectBody(t *testing.T) {
	r := setupEngine()
	s := &Server{}
...
func Test_Create_ServiceReturnsError(t *testing.T) {
	...
	s.service = mockService{mockUserService{returningModel: nil, returningError: errors.New(expectedErrorMessage)}}
	r.POST("/", s.CreateUser)
...
func Test_Create_Success(t *testing.T) {
	...
	s.service = mockService{mockUserService{returningModel: expectedModel}}
	r.POST("/", s.CreateUser)
